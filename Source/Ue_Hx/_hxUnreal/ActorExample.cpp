...
void AActorExample::StoreTransform()
{
...
void AActorExample::BeginPlay()
{
	...
	if (!hxInst)
    {
        hxInst = HxUnrealMain_ActorExample_new();
...
void AActorExample::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
    if (hxInst)
...
void AActorExample::Tick(float DeltaSeconds)
{
    if (hxInst)
    {
        StoreTransform();
