...
class Matrix
{
	...
	public function deltaTransformPoint(point:Point2D):Point2D
	{
		return new Point2D(point.x * a + point.y * c, point.x * b + point.y * d);
	}
	...
	public function transformPoint(pos:Point2D):Point2D
	{
		return new Point2D(__transformX(pos.x, pos.y), __transformY(pos.x, pos.y));
	}
